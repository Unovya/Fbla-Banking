...
const Transactions = () => {
    return (
        <>
            <div
                className=" bg-violet-800 text-3xl flex flex-row align-text-top font-normal mb-[-20px]  pb-[30px] mt-9 items-center w-[97%] h-14 rounded-lg ">
            ...
            <div className='flex flex-row bg-white rounded-xl h-[85%] shadow w-[97%]'>
                <TransWidget />
            </div>
        </>
)};
