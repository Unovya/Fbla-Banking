    ...
    return (
        <>
            ...
            {Popup && <div className='fixed inset-0 bg-black/50 flex justify-center items-center backdrop-blur-sm' onClick={closePopup}>
                <div
                    className={`fixed bg-gray-200 mt-10 top-[205px] left-0 bottom-0 right-0 w-[25%] justify-center items-center h-fit mx-auto backdrop-blur rounded-xl`} onClick={(e) => e.stopPropagation()}>
